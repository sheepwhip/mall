<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address,info) in addressInfo" :key="address.id">
...
import {mapState} from 'vuex'
  export default {
    ...
    mounted() {
        this.$store.dispatch('getUserAdderss');
    ...
    methods: {
        ...
        async submitOrder(){
            ...
            // 其余参数
            let data={
                consignee:this.userDefaultAddress.consignee,            // 收货人
                consigneeTel:this.userDefaultAddress.phoneNum,          // 收货人电话
                deliveryAddress:this.userDefaultAddress.fullAddress,    // 送货地址
                paymentWay:"ONLINE",                                    // 支付方式
                orderComment:this.msg,                                  // 买家留言
                orderDetailList:this.orderInfo.detailArrayList,         // 订单详情
            }
